...
const createTheme = (config: ThemeConfig): Extension => {
...
const createHighlightStyle = (config: ThemeConfig): Extension => {
...
export const dark: Extension = [createTheme(darkConfig), createHighlightStyle(darkConfig)];
...
export const light: Extension = [createTheme(lightConfig), createHighlightStyle(lightConfig)];
