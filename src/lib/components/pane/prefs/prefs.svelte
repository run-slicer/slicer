...
<div class="flex h-full w-full">
    <ResizablePaneGroup direction="horizontal" autoSaveId="prefs-horizontal">
        <ResizablePane defaultSize={20} minSize={9.5} maxSize={50}>
            <div class="flex h-full w-full flex-col justify-between gap-2 overflow-y-auto p-8">
        ...
        <ResizableHandle />
        <ResizablePane class="flex-1 scroll-p-8 overflow-y-auto p-8">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="right"
                                            >Alters the smoothness of UI corners.</TooltipContent
                                        >
                                    </Tooltip>
                                </div>
                            </TooltipProvider>
                            ...
                            <TooltipProvider>
                                <div class="flex items-center gap-2">
                                    ...
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="right"
                                            >Adjusts the default editor font size.</TooltipContent
                                        >
                                    </Tooltip>
                                </div>
                            </TooltipProvider>
                    ...
                    <div class="grid gap-2">
                        ...
                        <div class="grid min-h-[2.5rem] grid-cols-[12rem_10rem_1fr] items-center gap-4">
                            <TooltipProvider>
                                <div class="flex items-center gap-2">
                                    ...
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="right"
                                            >Default encoding for ZIP archive data.</TooltipContent
                                        >
                                    </Tooltip>
                                </div>
                            </TooltipProvider>
                            <Select type="single" bind:value={$workspaceArchiveEncoding}>
                                <SelectTrigger class="w-48">
                                    {encodings[$workspaceArchiveEncoding]?.label ||
                                        $workspaceArchiveEncoding.toUpperCase()}
                                </SelectTrigger>
                                <SelectContent>
                                    {#each Object.values(encodings) as encoding}
                                        <SelectItem value={encoding.id}>
                            ...
                            <TooltipProvider>
                                <div class="flex items-center gap-2">
                                    ...
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="right">
                                            Whether JDK classes should be made available to disassemblers (improves
                                            output quality).
                                        </TooltipContent>
                                    </Tooltip>
                                </div>
